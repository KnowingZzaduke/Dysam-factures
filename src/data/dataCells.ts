...
export const SecondCells = [
  {
    id: 5,
    type: "text",
    name: "detallemod",
    label: "Detalle de mod",
    placeholder: "Ingresa el detalle de mod",
  },
  {
    id: 6,
    type: "number",
    name: "basicoahora",
    label: "Básico ahora",
    placeholder: "Ingresa el básico de ahora",
  },
  {
    id: 7,
    type: "number",
    name: "horest",
    label: "Hor-Est",
    placeholder: "Ingresa el hor-est",
  },
  {
    id: 8,
    type: "number",
    name: "totaltiempohoras",
    label: "Total tiempo/horas",
    placeholder: "Ingresa el total del tiempo",
  },
  {
    id: 9,
    type: "number",
  ...
  },
  {
    ...
    placeholder: "Ingresa los días estimados",
  },
  {
    id: 11,
    type: "number",
...
export const ThirdCells = [
  {
    ...
    name: "horaauxilio",
    label: "Hora auxilio",
    placeholder: "Ingresa la hora de auxilio",
  },
  {
    id: 13,
    type: "number",
    name: "valorha",
    label: "Valor H.A",
    placeholder: "Ingresa el valor h.a",
  },
  {
    id: 14,
    type: "number",
    name: "numerohoras",
    label: "Número/horas",
    placeholder: "Ingresa el numero/hora ",
  },
  {
    id: 15,
    type: "number",
    name: "transportes",
    label: "Transportes",
    placeholder: "Ingresa los transportes",
  },
  {
    id: 16,
    type: "number",
...
export const FourthCells = [
  {
    id: 13,
    type: "text",
    name: "transporteequiposcontratados",
